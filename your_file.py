...
# example = [ 1 : 4 : -1 ]
 ...
 # information of class is stored in attributes,functions of class are called as methods
 class dog():
    def color(self):
        print("white")
...
# starts by 0 and stopts 1 number below the number pass to it.# we can use list to genarete large list of numbers
